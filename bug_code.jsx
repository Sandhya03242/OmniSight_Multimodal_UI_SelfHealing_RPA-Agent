    ...
    <div className="min-h-screen bg-gray-100">
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="relative">
                ...
                {/* =================================================
                    INTENTIONAL OMNISIGHT UI BUG

                    BUG:
                    The Add to Cart button is absolutely positioned
                    over the bottom of the product image.

                    Expected AI detection:
                    "Add to Cart button overlaps product image."

                    Expected healing:
                    Remove the absolute positioning and place the
                    button inside the normal product details section.
                ================================================== */}
      ...
      {cart.length > 0 && (
        <section className="bg-white max-w-7xl mx-auto px-8 py-8 mb-10 rounded-xl shadow">
          ...
          <button className="mt-5 bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700">
            Proceed to Checkout
          </button>
